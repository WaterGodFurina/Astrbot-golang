 ...
 */
export const listChatProjectWorkspaceFiles = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ListChatProjectWorkspaceFilesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListChatProjectWorkspaceFilesResponse, ListChatProjectWorkspaceFilesError, ThrowOnError>({
        ...options,
 ...
 */
export const getChatProjectWorkspaceFile = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetChatProjectWorkspaceFileData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetChatProjectWorkspaceFileResponse, GetChatProjectWorkspaceFileError, ThrowOnError>({
        ...options,
 ...
 */
export const downloadChatProjectWorkspaceFile = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DownloadChatProjectWorkspaceFileData, ThrowOnError>) => {
    return (options?.client ?? client).get<DownloadChatProjectWorkspaceFileResponse, DownloadChatProjectWorkspaceFileError, ThrowOnError>({
        ...options,
...
/**
 * Set whether a plugin may idle-sleep (per-plugin sleep policy)
 */
export const setPluginIdleSleepById = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetPluginIdleSleepByIdData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetPluginIdleSleepByIdResponse, SetPluginIdleSleepByIdError, ThrowOnError>({
        ...options,
        url: '/api/v1/plugins/idle-unload'
    });
};

/**
 * Set the global idle auto-sleep threshold in minutes (0 disables)
 */
export const setPluginIdleSleepGlobal = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<SetPluginIdleSleepGlobalData, ThrowOnError>) => {
    return (options?.client ?? client).post<SetPluginIdleSleepGlobalResponse, SetPluginIdleSleepGlobalError, ThrowOnError>({
        ...options,
        url: '/api/v1/plugins/idle-unload-global'
    });
};
 ...
 */
export const updatePluginLogLevel = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdatePluginLogLevelData, ThrowOnError>) => {
    return (options?.client ?? client).put<UpdatePluginLogLevelResponse, UpdatePluginLogLevelError, ThrowOnError>({
        ...options,
 ...
 */
export const installPluginFromGit = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<InstallPluginFromGitData, ThrowOnError>) => {
    return (options?.client ?? client).post<InstallPluginFromGitResponse, InstallPluginFromGitError, ThrowOnError>({
        ...options,
